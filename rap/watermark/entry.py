...
from rap.common.utils import timeutils
...
from rap.watermark.defaults import config as default_config
...
def run(directory, config=None, edit_config=None, verbose=None):
    ...
    timespan, _ = timeutils.timeit(run_task, directory, verbose)
